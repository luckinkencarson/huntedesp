...
repeat
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'hunted.lol<font color="rgb(115, 100, 215)">lol</font> - uid: <font color="rgb(115, 100, 215)">' .. uid .. '</font> / fps: <font color="rgb(115, 100, 215)">' .. fpsValue .. '</font> / ping: <font color="rgb(115, 100, 215)">' .. ping .. '</font> / time: <font color="rgb(115, 100, 215)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'hunted.lol<font color="rgb(115, 100, 215)">lol</font> || fallen',
